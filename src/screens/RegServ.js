...
export default function RegServ() {
...
const handleSubmit = async (e) => {
    ...
    const response = await fetch("http://localhost:5000/api/auth/regRest", {
        ...
        body: JSON.stringify({ CategoryName: credentials.category, name: credentials.name, img: credentials.img, 
            options: {"+installation":credentials.options1,"regular":credentials.options2}, description: credentials.description,
      ...
      <Navbar />
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-dark border-success rounded' onSubmit={handleSubmit}>
            ...
            <div className="m-3">
              <label htmlFor="name" className="form-label">Link for component image Image</label>
              <input type="text" className="form-control" name='img' value={credentials.img} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
              <label htmlFor="name" className="form-label">Product price with Installation and delivery(Not Required for service)</label>
            ...
            <div className="m-3">
              <label htmlFor="name" className="form-label">Procduct price(Not Required for service)</label>
            ...
            <div className="m-3">
              <label htmlFor="name" className="form-label">Name of the shop</label>
            ...
            <div className="m-3">
              <label htmlFor="address" className="form-label">Location of Store</label>
              <fieldset>
